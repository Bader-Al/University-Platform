...
class AcademicDraggableBottomSheet extends StatelessWidget {
  AcademicDraggableBottomSheet({this.pageContent, this.pageIndex, this.title});
  final List pageContent;
  final int pageIndex;
  final String title;
  ScrollController insideContoller;
...
class AcademicSheetHeader extends StatelessWidget {
  const AcademicSheetHeader();
  @override
  Widget build(BuildContext context) {
    return 
    // SliverAppBar(
    ...
    //   title: 
      ...
      Container(
          ...
          child: Padding(
              padding: const EdgeInsets.only(top: 5.0, bottom: 5),
              child: Row(children:[...headingItems(context)])));
    // );
  }
}
